...
def collect_all_paths(pos_dirs, neg_dirs, input_size):
    """
    ...
    for directory in pos_directories:
        dataset.extend(_collect_image_paths(directory, input_size))
...
def parse_args():
    ...
    parser.add_argument(
        "--input_size", "-s", help="Number of images per source to consider", type=int, default=7000)
    parser.add_argument(
